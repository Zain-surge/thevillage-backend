...
async function getOrderDetails(orderId) {
  try {
    ...
    const orderQuery = `
      SELECT 
        o.order_id, o.payment_type,o.transaction_id, o.order_type, o.total_price, o.extra_notes, o.order_source,o.change_due,o.status,o.driver_id,o.brand_name,o.paid_status,
